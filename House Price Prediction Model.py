...
#very few na values so we will drop them in the dataset
...
#for each we give an 1 for true and a 0 for false if the property is located in a specific proximity. So for each proximity option a property would have one true and four false
...
#make sure we did not drop any columns in the test data
train_data
